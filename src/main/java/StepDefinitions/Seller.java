...
//        Thread.sleep(5000);
    ...
    public void seller_select_noThanks() throws InterruptedException {
        ...
        noThanksbuttonjse.executeScript("scroll(0, 5000)");
...
//        Thread.sleep(5000);
    ...
    public void seller_select_type_of_property() throws InterruptedException {
        ...
        //*[@id="HasAlternativeCorrespondenceTrue"]
    ...
    public void seller_select_verbal_comms() throws InterruptedException {
        JavascriptExecutor js = (JavascriptExecutor) driver;
        WebElement verbalCommButtonNo = driver.findElement(By.xpath("//*[@id='about-your-business-form']/div[16]/div/label[2]"));
    ...
    public void seller_add_details_of_principal() throws InterruptedException {
        ...
        driver.findElement(By.name("loqate-address-lookup-search")).sendKeys("E");
        Thread.sleep(15000);

        //Click on list of addresses displayed - addressLookupSole1
        JavascriptExecutor listofAddress1 = (JavascriptExecutor) driver;
        WebElement listofAddress2 = driver.findElement(By.xpath("/html/body/div[3]/div[4]/div[2]/div[1]/span"));
        //WebElement listofAddress2 = driver.findElement(By.xpath("/html/body/div[3]/div[1]/div[2]/div/span"));
        listofAddress1.executeScript("arguments[0].click();", listofAddress2);
        Thread.sleep(15000);
...
//        Thread.sleep(10000);
    ...
    public void seller_add_settlement_bank_account() throws InterruptedException {
       ...
       // WebElement bankdetailpanel2 = driver.findElement(By.xpath("*[@id='add-bank-button-5429']"));
...
//        driver.findElement(By.xpath("//*[@id='BankName']")).sendKeys("Some Bank");
//        Thread.sleep(5000);

        //Select the Bank Account Legal Name
        driver.findElement(By.xpath("//*[@id='outer-circle']")).click();
        Thread.sleep(5000);

        //Select DirectDebit as NO
        driver.findElement(By.xpath("//*[@id='AddEditForm']/div[2]/div[1]/div[4]/div[5]/div[1]/div/label[2]")).click();
        Thread.sleep(5000);

        //Save the Details on Settlement Bank Account
        JavascriptExecutor settlementBankSave1 = (JavascriptExecutor) driver;
        WebElement settlementBankSave2 = driver.findElement(By.xpath("//*[@id='saveButton']"));
        settlementBankSave1.executeScript("arguments[0].click();", settlementBankSave2);
        Thread.sleep(5000);
    }
    ...
    public void seller_add_delivery_details() throws InterruptedException {
        ...
        //WebElement deliverydetailspanel2 = driver.findElement(By.xpath("//*[@id='add-delivery-button-6641']"));
        Thread.sleep(3000);
